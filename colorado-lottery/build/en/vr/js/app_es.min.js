...
var Menu3d=function(){
	function Menu3d(){
		...
		this.buttons=[];
		this.links=[
			{path:"climbing",img:"./images/3d/buttons/vr-card-climbing.png"},
			{path:"biking",img:"./images/3d/buttons/vr-card-biking.png"},
			{path:"skiing",img:"./images/3d/buttons/vr-card-skiing.png"},
			{path:"mustang",img:"./images/3d/buttons/vr-card-mustang.png"},
			{path:"ouray",img:"./images/3d/buttons/vr-card-ouray.png"},
			{path:"game",img:"./images/3d/buttons/vr-card-game.png"}
		]
	}
	...
	var Config=function Config(){
		...
		Config.MENU_OPEN_ICON="./images/3d/buttons/icon-menu-256.png";
		Config.MENU_COSE_ICON="./images/3d/buttons/icon-close-256.png";
		Config.BUTTON_DISTANCE=5;
		Config.BUTTON_TOGGLE_DISTANCE=14;
		Config.MENU_TOGGLE_Y=Config.BASE_Y-8;
		Config.BUTTON_SIZE=1;
		Config.ARROW_IMG="./images/3d/arrow.png";
		Config.ARROWS_Y=0;
		Config.ARROWS_DISTANCE=8;
		Config.LOOK_UP_IMG="./images/3d/look-up-text.png";
		Config.LOOK_UP_Y=-10;
		Config.LOOK_UP_DISTANCE=3;
		Config.GAME_SPHERE_RADIUS=6;
		Config.GAME_SPHERE_Y_RANGE=2;
		Config.INSTRUCTIONS_BANNER_IMG="./images/3d/instruction-text-overlay.png";
		Config.VIDEO_CLIMBING_TEXT_IMG="./images/3d/climbing.png";
		Config.VIDEO_BIKING_TEXT_IMG="./images/3d/biking.png";
		Config.VIDEO_SKIING_TEXT_IMG="./images/3d/skiing.png";
		Config.VIDEO_MUSTANG_TEXT_IMG="./images/3d/mustang.png";
		Config.VIDEO_OURAY_TEXT_IMG="./images/3d/ouray.png";
		Config.VIDEO_INTRO_TEXT_IMG="./images/3d/intro_es.png";
		Config.VIDEO_LOTTERY_LOGO="./images/3d/lottery-logo.png";
		...
		Config.GAME_SCORE_BG_IMG="./images/3d/score-background-512.png";
		Config.GAME_SECONDS=30;
		Config.GAME_START_BUTTON_IMAGE="./images/3d/buttons/game-start-button.png";
		Config.GAME_REPLAY_BUTTON_IMAGE="./images/3d/buttons/game-replay-button.png";
