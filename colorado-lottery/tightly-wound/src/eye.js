...
Eye = function(game, head, scale) {
    ...
    //initialize the circle sprites: dead eyes

    this.deadCircle = this.game.add.sprite(
        this.head.body.x, this.head.body.y, "eye-dead"
    );
    this.deadCircle = this.initCircle(this.deadCircle);
    this.deadCircle.alpha = 0;

    //initialize the circle sprites: eye whites
    ...
    //initialize the circle sprites: eyes
...
Eye.prototype = {
    ...
    updateConstraints: function(offset) {
        ...
        //create a lock constraint if it doesn't already exist
            ...
            this.lock2 = this.game.physics.p2.createLockConstraint(
                this.deadCircle.body, this.head.body, offset, 0
            );
        }
     ...
     */
    destroy: function() {
        this.blackCircle.alpha = 0;
        this.whiteCircle.alpha = 0;
        this.deadCircle.alpha = 1;
