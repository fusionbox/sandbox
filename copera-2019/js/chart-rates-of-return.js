...
am4core.ready(function() {
  ...
  '<div class="d-flex">'+
  '<div class="mx-1 pb-1"><div style="font-family:lorimer-no-2-condensed;font-size:30px;">{valueY}%</div><div>{categoryX}</div></div>'+
  '<div class="mx-1 pb-1"><div style="font-family:lorimer-no-2-condensed;font-size:30px;">{benchmark}%</div><div>Policy Benchmark<br>Return</div></div></div>'+
  '</div>';
